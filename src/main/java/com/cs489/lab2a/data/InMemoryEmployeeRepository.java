...
public class InMemoryEmployeeRepository implements EmployeeRepository {
  ...
  private final List<Employee> employees = List.of(
      ...
      new Employee(7L, "Maya", "Patel", LocalDate.of(2023, 4, 1), new BigDecimal("90000.00"), null),
      new Employee(11L, "Robert", "Moana", LocalDate.of(2023, 5, 1), new BigDecimal("100000.00"), null),
      new Employee(9L, "May", "Moana", LocalDate.of(2023, 5, 1), new BigDecimal("110000.00"), null),
